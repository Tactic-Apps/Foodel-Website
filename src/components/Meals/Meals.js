...
const meals = {
  ...
  meal2: {
    imageName: img2,
    imageAlt: "Salmon with vegetables",
  },
  meal3: {
    imageName: img3,
  ...
  meal5: {
    imageName: img5,
    imageAlt: "Granola with fruit and nuts",
  },
  meal6: {
    imageName: img6,
  ...
  meal7: {
    imageName: img7,
    imageAlt: "Complex salad with chicken",
  },
  meal8: {
    imageName: img8,
...
const Meals = (props) => {
  return (
    <section className="section-meals">
      <ul className="meals-showcase clearfix">{mealList()}</ul>
    </section>
  );
};
